declare class Pickup extends BaseElement {
   ...
   **/
  setType(thePickup: Pickup, theType: 2, weapon: number, ammo?: number): boolean;
   ...
   * @see https://wiki.mtasa.com/wiki/SetPickupType
   **/
  setType(thePickup: Pickup, theType: 0 | 1, amount: number): boolean;
   ...
   * @see https://wiki.mtasa.com/wiki/SetPickupType
   **/
  setType(thePickup: Pickup, theType: 3, modelid: number): boolean;
}
