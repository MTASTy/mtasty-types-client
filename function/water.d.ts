 ...
 **/
declare function getWaterLevel(theWater: Water): number | false;
 ...
 * @param posZ The Z axis position.
 * @param bCheckWaves bCheckWaves Include the water levels of waves in the ocean, lakes and ...
 * @returns Returns an integer of the water level if the localPlayer/position is near the water (-3 to 20 on the Z coordinate) else false if there's no water near the localPlayer/position.
 * @see https://wiki.mtasa.com/wiki/GetWaterLevel
 **/
declare function getWaterLevel(posX: number, posY: number, posZ: number, bCheckWaves?: boolean): number | false;
 ...
 **/
declare function isWaterDrawnLast(): boolean;
