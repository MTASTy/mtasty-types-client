 ...
 * @see https://wiki.mtasa.com/wiki/TriggerLatentServerEvent
 **/
declare function triggerLatentServerEvent(event: string, persist: boolean, theElement: Element, ...arguments: any[]): boolean;
 ...
 * @see https://wiki.mtasa.com/wiki/TriggerLatentServerEvent
 **/
declare function triggerLatentServerEvent(event: string, bandwidth: number, theElement: Element, ...arguments: any[]): boolean;
 ...
 * @see https://wiki.mtasa.com/wiki/TriggerLatentServerEvent
 **/
declare function triggerLatentServerEvent(event: string, theElement: Element, ...arguments: any[]): boolean;
