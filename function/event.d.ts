 ...
 * - Note: See Event Source BaseElement for a descriptive visualization of the event system handling an event trigger.
 ...
 **/
declare function cancelEvent(): true;
 ...
 * @param arguments A list of arguments to trigger with the event. You can pass any Lua data type (except functions). You can also pass elements. The total amount of data should not exceed 100MB.
 ...
 **/
declare function triggerLatentServerEvent(event: string, bandwidth: number, persist: boolean, theElement: BaseElement, ...arguments: any[]): boolean;
 ...
 * @see https://wiki.mtasa.com/wiki/TriggerLatentServerEvent
 **/
declare function triggerLatentServerEvent(event: string, persist: boolean, theElement: BaseElement, ...arguments: any[]): boolean;
 ...
 * @see https://wiki.mtasa.com/wiki/TriggerLatentServerEvent
 **/
declare function triggerLatentServerEvent(event: string, bandwidth: number, theElement: BaseElement, ...arguments: any[]): boolean;
 ...
 * @see https://wiki.mtasa.com/wiki/TriggerLatentServerEvent
 **/
declare function triggerLatentServerEvent(event: string, theElement: BaseElement, ...arguments: any[]): boolean;
 ...
 * @param arguments A list of arguments to trigger with the event. You can pass any lua data type (except functions).
 ...
 **/
declare function triggerServerEvent(event: string, theElement: BaseElement, ...arguments: any[]): boolean;
