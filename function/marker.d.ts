 ...
 **/
declare function createMarker(x: number, y: number, z: number, theType?: "checkpoint" | "ring" | "cylinder" | "arrow" | "corona", size?: number, r?: number, g?: number, b?: number, a?: number): Marker | false;
